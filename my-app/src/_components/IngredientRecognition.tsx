...
export default function IngredientRecognition() {
  ...
  const handleGenerate = () => {
    if (!text.trim()) return;
    setResult(`Ingredients recognized from description: ${text}`);
  };
    ...
    <div className="w-[580px]">
      <div className="w-[580px]">
        ...
        <div className="flex flex-col gap-2 mt-3">
          ...
          <textarea
            className="border border-gray-300 rounded-md px-3 py-2 w-[580px] h-[130px]"
            placeholder="Орц тодорхойлолт..."
            value={text}
        ...
        <div className="flex w-full items-end">
          <button
            ...
            className="mt-3 ml-[490px] p-3 bg-black opacity-80 rounded-[5px] text-white"
          >
            Generate
          </button>
        </div>
      ...
      <div className="w-full mt-10">
        ...
        <span>
          {result || "First, enter your text to recognize ingredients."}
        </span>
      </div>
    </div>
  );
